...
do_install() {
	install -d ${D}/${bindir}
	install -m 0755 ${B}/dfx-demo ${D}/${bindir}

	install -d ${D}${datadir}/avs/bitstreams
	install -m 0755 ${WORKDIR}/bitstreams/*.bin ${D}${datadir}/avs/bitstreams
...
FILES:${PN} += "${datadir}/avs/bitstreams/"
