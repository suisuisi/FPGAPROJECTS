...
/**
 * CRC lookup-table for CRC16-CCITT calculation
 */
...
/**
 * Build the CRC-16 CCITT
 * @param pdata Pointer to data buffer
 * @param len   Data-length
 * @param crc   so-far calculated crc, or CRC16_InitValue to start a new calculation
...
{
	return crc16_update(&data, sizeof(data), crc);
}
